  ...
  return (
    <View className='w-full h-full bg-screenBg'>
      ...
      <View className='w-full h-1/3 flex-col justify-center items-center'>
        <TextInput className='w-3/4 bg-itemBgLight rounded-md text-itemText text-xl pl-3 pb-1 mb-3'
          placeholder="Enter your email" 
          value={username} 
          onChangeText={setUsername} 
        />
        <TextInput className='w-3/4 bg-itemBgLight rounded-md text-itemText text-xl pl-3 pb-1'
      ...
      <View className='w-full h-1/3 flex-col items-center'>
        {/* Continue w/ Google */}
        <TouchableOpacity className='w-3/4 bg-itemBgDark flex-row items-center justify-center rounded-md py-2'>
          <Image className='w-[30px] h-[30px] mr-5' source={require('../assets/images/google.png')} />
  
          <Text className='text-xl text-itemText'>Continue with Google</Text>
        </TouchableOpacity>
        ...
        <View className='w-3/4 h-1/2 flex-row mt-5 items-start justify-center '>
          <TouchableOpacity className='w-5/12 bg-itemBgDark flex items-center justify-center rounded-md py-1'>
            <Text className='text-xl text-itemText'> LOGIN</Text>
          </TouchableOpacity>
          <View className='w-2/12'></View>
          <TouchableOpacity className='w-5/12 bg-itemBgDark flex items-center justify-center rounded-md py-1'>
            <Text className='text-xl text-itemText'>SIGN UP</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
