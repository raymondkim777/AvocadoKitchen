...
const HomePage = ({ navigation }) => {
  ...
  const [dayCSS, setDayCSS] = useState(
                  ...
                  {days.map((day,index) => (
                    index == 0? 
                      <View key={`day-${index}`} className='shrink w-full h-8'>
                        ...
                        activeOpacity={0.96} onPress={()=>setDayFocus(index)}>
                          <View className={`w-full h-full items-center justify-center rounded-t-lg ${dayCSS[index]}`}>
                ...
                <View className='grow w-full h-40 bg-itemBgLight rounded-b-lg p-1.5'>
                  <View className='flex flex-col w-full h-full'>
                    ...
                    <View className='flex flex-1 h-full mt-1.5'>
                      <MealSum callback={handleMealPress} item={meals[dayIndex].data[mealIndex]} />
                    </View>
                  </View>
                </View>
              </View>
