...
const SmallButton = ({text, callback, background = 'bg-buttonBg', disabled=false}) => (
  <TouchableHighlight className={`w-fit h-9 rounded-lg`}
  activeOpacity={0.9} onPress={callback} disabled={disabled}>
    <View className={`w-fit h-full px-3 items-center justify-center ${background} rounded-lg`}>
